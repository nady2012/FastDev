...
public class SwitchWindow extends CompoundButton {

    private final String TAG = SwitchWindow.class.getSimpleName();
    ...
    public SwitchWindow(Context context, AttributeSet attrs) {
        this(context, attrs, -1);
    }

    public SwitchWindow(Context context, AttributeSet attrs, int defStyle) {
