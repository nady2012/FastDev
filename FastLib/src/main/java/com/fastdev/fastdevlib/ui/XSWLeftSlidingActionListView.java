...
public class XSWLeftSlidingActionListView extends XSWSafeListView {
    ...
    public XSWLeftSlidingActionListView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public XSWLeftSlidingActionListView(Context context, AttributeSet attrs, int defStyle) {
