...
public class XSPTimerView extends LinearLayout {
    ...
    public XSPTimerView(Context context, AttributeSet attrs) {
        this(context, attrs, -1);
    }

    public XSPTimerView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        TypedArray ta = context.getTheme().obtainStyledAttributes(attrs, R.styleable.XSPTimerView, defStyle, 0);
        seconds = ta.getInteger(R.styleable.XSPTimerView_max_seconds, MAX_SECONDS);
        showStr = ta.getString(R.styleable.XSPTimerView_show_text);
        finishedStr = ta.getString(R.styleable.XSPTimerView_finished_text);
