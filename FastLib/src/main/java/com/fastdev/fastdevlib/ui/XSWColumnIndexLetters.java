...
import com.fastdev.fastdevlib.util.XSScreenDensityUtil;
...
public class XSWColumnIndexLetters extends View {
    ...
    public XSWColumnIndexLetters(Context context, IndexIcon[] icons, String[] letters) {
        this(context, null);
        this.icons = icons;
        this.letters = letters;
    }

    public XSWColumnIndexLetters(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        initDefaultAttrs();
    ...
    private void initDefaultAttrs() {
        ...
        if (XSScreenDensityUtil.isNormalScreenDensityDpi(mContext)) {
