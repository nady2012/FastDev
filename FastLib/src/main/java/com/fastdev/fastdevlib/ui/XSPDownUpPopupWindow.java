...
public class XSPDownUpPopupWindow extends PopupWindow {
     ...
     */
    public XSPDownUpPopupWindow(Activity context, int txtResID, int[] btnResIDs, int[] btnBackgroundResIDs,
     ...
     *            The key listener to attach to this popup window
     */
    public XSPDownUpPopupWindow(Activity context, int txtResID, int[] btnResIDs, View.OnClickListener[] itemsListener,
